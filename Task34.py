...
#pesnya = "пара-ра-рам рам-пам-папам па-ра-па-дa"
pesnya = "пара-ра-рам пира-пура"
glasnyii = ("а", "и", "е", "ё", "о", "у", "ы", "э", "ю", "я")
tempPesnya = pesnya.split()

print(tempPesnya)
count = 0
checkList = set()

for i in range(len(tempPesnya)):
    for fraza in tempPesnya[i]:
       if fraza in glasnyii:
           count += 1
    checkList.add(count)
    count = 0
